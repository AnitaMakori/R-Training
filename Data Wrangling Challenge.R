...
household_merged_data3 <- household_merged_data2%>%
  mutate(study_arm = ifelse(village.x%in%c("Lependera", "Saale-Sambakah", "Namarei", "Manyatta Lengima", "Lokoshula", "TubchaDakhane", "Rengumo-Gargule"), "Study arm 1", 
                            ifelse(  village.x%in%c("Uyam  village", "Rongumo_kurkum", "Manyatta K.A.G", "Ltepes Ooodo", "Lbaarok1"), "Study arm 2", 
                                     "Study arm 3")))
